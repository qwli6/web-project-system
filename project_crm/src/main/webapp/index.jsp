...
<head>
    ...
    <title>后台管理主页</title>
    <meta name="keywords" content="36氪, 36kr, 36tr, 创业, 想创业, 投资, 融资, 创投媒体,
    创业公司, 科技新闻, 移动互联网, 资讯平台, 开放日, 互联网创业"/>
    ...
    <div class="container">
        ...
        <div id="navbar">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="<s:action name="logOut" namespace="/user"/>">安全退出</a></li>
            </ul>
        </div>
    </div>
</nav>
            ...
            <div class="btn-group-vertical" role="group" align="center">
                <div class="btn-group" role="group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<s:action name="addPage" namespace="/customer"/>">新增客户</a></li>
                        <li><a href="<s:action name="list" namespace="/customer"/>">客户列表</a></li>
                    </ul>
                </div>
